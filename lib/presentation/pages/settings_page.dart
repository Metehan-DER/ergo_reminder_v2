...
class _SettingsPageState extends ConsumerState<SettingsPage> {
  ...
  // DIP: Unvan listeleri artık SettingsEntity'den okunuyor.
  // Bu sayfanın presentation-layer bilgisi değil, domain verisi.
  List<String> get _titles => SettingsEntity.availableTitles;
  // DIP: İngilizce unvan karşılıkları da artık SettingsEntity'den okunuyor.
  static Map<String, String> get _englishTitles => SettingsEntity.titleTranslations;
